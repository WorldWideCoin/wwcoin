...
public:
    CMainParams() {
        ...
        bnGenesisProofOfWorkLimit = CBigNum(~uint256(0) >> 20);
        nSubsidyHalvingInterval = 100000;

        // Build the genesis block. Note that the output of the genesis coinbase cannot
        // be spent as it did not originally exist in the database.
  
        const char* pszTimestamp = "The Times 6-6-14 D-Day live: humbled leaders pay tribute";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        genesis.nVersion = 1;
        genesis.nTime    = 1402090806;
        genesis.nBits    = 0x1e0fffff;
        genesis.nNonce   = 76554556;
  ...
  //      genesis.print();
        ...
        assert(genesis.hashMerkleRoot == uint256("0x2df3afa60ed809c9767b00e6e3098f563bcd4709c769ecba4cfbfef3ad3cb76a"));
...
public:
    CTestNetParams() {
        ...
        genesis.nTime = 1402090818;
        genesis.nBits = 0x1e0fffff; //already from mainnet
        genesis.nNonce = 34546592;
        ...
        //000000113ef50c953f68038417037e2f582da40b6c67992a84e11abb63a9288a

        printf("Testnet gen block \n %s\n", hashGenesisBlock.ToString().c_str());
        printf("%s\n", genesis.hashMerkleRoot.ToString().c_str());
        genesis.print();
...
public:
    CRegTestParams() {
        ...
        bnGenesisProofOfWorkLimit = CBigNum(~uint256(0) >> 1);
